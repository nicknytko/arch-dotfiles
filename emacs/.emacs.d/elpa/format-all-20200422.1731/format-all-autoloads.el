...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "format-all" '("fish-indent" "fprettify" "format-all-" "terraform-fmt" "scalafmt" "shfmt" "snakefmt" "sqlformat" "styler" "swiftformat" "rufo" "rustfmt" "perltidy" "prettier" "purty" "ocp-indent" "nixfmt" "mix-format" "latexindent" "ledger-mode" "lua-fmt" "ktlint" "jsonnetfmt" "istyle-verilog" "html-tidy" "gofmt" "elm-format" "emacs-lisp" "define-format-all-formatter" "dartfmt" "dfmt" "dhall" "dockfmt" "cmake-format" "crystal" "bibtex-mode" "black" "brittany" "buildifier" "asmfmt")))
